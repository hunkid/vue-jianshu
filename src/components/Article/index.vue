      ...
      <div class="preview">
        <div class="author-info">
          <div class="btn btn-small btn-success follow" id="follow_user_445173">
            <a data-type="json" data-user-slug="29010e584814" data-remote="true" rel="nofollow" data-method="post"
               href="#"><i class="fa fa-plus"></i>  <span>添加关注</span></a>
          </div>
          <a class="avatar" href="#">
...
.article-container .author-info .follow,
.article-container .author-info .following {
  float: right;
  margin-top: 10px;
}
