  ...
  <div class="outer-container">
    <div class="publish_result">
      <transition name="fade">
        <p v-show="show_result"
           class="publish-active active-result">{{resMsg}}</p>
      </transition>
    </div>
    <div class="note-editor">
      ...
      <div class="wrapper-body">
        <quill-editor ref="myTextEditor" v-model="note.content" :config="editorOption" @blur="onEditorBlur($event)"
